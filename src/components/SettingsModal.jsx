        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg border border-sf-dark-700 bg-sf-dark-900/60 px-3 py-3">
            ...
            <div className="mt-2 flex flex-wrap gap-1.5 text-[10px] text-sf-text-secondary">
              {['get_project', 'get_timeline', 'get_assets', 'get_ai_review_passes', 'diagnose_comfyui_connection', 'set_comfyui_connection', 'repair_comfyui_connection', 'control_comfyui_launcher', 'get_comfyui_launcher_logs', 'validate_comfyui_nodes', 'list_comfystudio_workflows', 'inspect_comfystudio_workflow', 'check_export_readiness', 'inspect_clip', 'inspect_timeline_frame', 'prepare_generation_from_timeline_context', 'queue_prepared_generation', 'queue_timeline_generation_batch', 'queue_prompt_generation_batch', 'inspect_timeline_range', 'inspect_visible_shots', 'get_generation_status', 'get_music_video_status', 'analyze_timeline', 'analyze_music_video_workflow', 'set_clip_label_color', 'set_clips_enabled', 'add_timeline_markers', 'remove_timeline_markers', 'set_timeline_marker_properties', 'create_timeline', 'create_asset_folder', 'move_assets_to_folder', 'add_track', 'add_asset_to_timeline', 'add_assets_to_timeline', 'add_solid_color', 'add_text_clip', 'add_shape_clip', 'duplicate_clip', 'update_text_clip', 'update_shape_clip', 'set_clip_keyframes', 'export_timeline'].map((tool) => (
